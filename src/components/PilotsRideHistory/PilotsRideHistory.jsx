...
const PilotsRideHistory = () => {
  ...
  const getall = () => {
    console.log('hello')
    axios
      .get(`https://3.89.57.212:8080/app/bookride/Driver/${logindata.email}`)
      .then((res) => {
    ...
    axios
      .get(
        `https://3.89.57.212:8080/app/userRideHistory/getDriverByemail/${logindata.email}/upcoming`
      )
      .then((res) => {
    ...
    axios
      .get(
        `https://3.89.57.212:8080/app/userRideHistory/getDriverByemail/${logindata.email}/ongoing`
      )
      .then((res) => {
    ...
    axios
      .get(
        `https://3.89.57.212:8080/app/userRideHistory/getAllRideID/completed/${logindata.email}`
      )
      .then((res) => {
        axios
          .post(
            `https://3.89.57.212:8080/app/bookRide/getALLRide/Byid`,
            res.data
          )
          .then((response) => {
                        ...
                        <div style={{ paddingTop: '5%' }}>
                          <Button
                            onClick={() => {
                              axios
                                .put(
                                  `https://3.89.57.212:8080/app/updateRide/ById/${DriverRides[0].id}/completed`
                                )
                                .then(() => {
                                  getall()
                                })
                        ...
                        <div style={{ paddingTop: '5%' }}>
                          <Button
                            onClick={() => {
                              axios
                                .put(
                                  `https://3.89.57.212:8080/app/updateRide/ById/${DriverRides[0].id}/ongoing`
                                )
                                .then(() => {
                                  getall()
                                })
